...
function DatosVehiculosCuatro(props) {
    const {
        vehiculoCuatroCrear,
    ...
    useEffect(() => {
        if (vehiculoBorrar && !duplicar && !vehiculoCuatroEditar) {
            setVehiculoBorrar(false);
        }
    }, [vehiculoBorrar]);

    useEffect(() => {
        if (vehiculoCuatroCrear) {
            setMarcaVeh("");
            setAnnoVeh("");
            setModeloVeh("");
            setCilindrajesVeh("");
    ...
    useEffect(() => {
        if (vehiculoCuatroEditar) {
            setMarcaVeh(marcaVehCuatro);
            setAnnoVeh(annoVehCuatro);
            setModeloVeh(modeloVehCuatro);
            setCilindrajesVeh(cilindrajeVehCuatro);
            setCarroceriaVeh(carroceriaVehCuatro);
            setTransmisionVeh(transmisionVehCuatro);
            setCombustibleVeh(combustibleVehCuatro);
            setTraccionVeh(traccionVehCuatro);
            listCarrocerias.forEach((row) => {
                if (
                    Number.parseInt(row.id) ===
                    Number.parseInt(carroceriaVehCuatro)
                ) {
            ...
            listMarcas.forEach((row) => {
                if (
                    Number.parseInt(row.id) === Number.parseInt(marcaVehCuatro)
                ) {
            ...
            annos.forEach((row) => {
                if (
                    Number.parseInt(row.id) === Number.parseInt(annoVehCuatro)
                ) {
            ...
            listModelos.forEach((row) => {
                if (
                    Number.parseInt(row.id) === Number.parseInt(modeloVehCuatro)
                ) {
            ...
            listModelos &&
                listModelos.forEach((row) => {
                    if (
                        Number.parseInt(row.marca) ===
                            Number.parseInt(marcaVehCuatro) &&
                        Number.parseInt(row.carroceria) ===
                            Number.parseInt(carroceriaVehCuatro)
                    ) {
                        let item = {
            ...
            listCilindrajes &&
                listCilindrajes.forEach((row) => {
                    if (
                        ...
                        Number.parseInt(modeloVehCuatro)
                    ) {
                        let item = {
                            id: row.id,
                            carroceria: row.carroceria,
    ...
    useEffect(() => {
        ...
        console.log("ARROCERIAS : ", list);
        setListCarrocerias(list);

        setAnnos(JSON.parse(localStorage.getItem("datosannosvehiculos")));
        const newDetTipo = [];
        setTipoVeh(tipoVehSelec);

        console.log("TIPO VEH : ",Number.parseInt(tipoVehSelec));
        alert(tipoVehSelec)
        list.forEach((row) => {
            if (
                parseInt(row.tipovehiculo) ==
                parseInt(tipoVehSelec)
            ) {
                alert("ENTRE")
                let item = {
                    id: row.id,
        ...
        console.log("newDetTipo : ", newDetTipo);
    ...
    useEffect(() => {
        if (controlGrabar) {
                ...
                vehiculosSeleccionados &&
                    vehiculosSeleccionados.map((items) => {
                        if (items.dato.valor == vehiculo) {
                            ...
                            setTextoMensajes(
                                "Heey, No puedes grabar dos vehícuos iguales 42!"
                            );
                            continuar = false;
                            return;
                            setcontrolGrabar(false);
            ...
            setTipoVehCuatro(tipoVehSelec);
            setMarcaVehCuatro(marcaVeh);
            setAnnoVehCuatro(annoVeh);
            setModeloVehCuatro(modeloVeh);
            setcilindrajeVehCuatro(cilindrajesVeh);
            setCarroceriaVehCuatro(carroceriaVeh);
            settransmisionVehCuatro(transmisionVeh);
            setcombustibleVehCuatro(combustibleVeh);
            settraccionVehCuatro(traccionVeh);
    ...
    const handleChange = (selectedOptions) => {
        ...
        setCarrocerias(newDet);
        if (!vehiculoCuatroEditar && !vehiculoCuatroDuplicar)
    ...
    const handleChangeBrand = (selectedOptions) => {
        ...
        if (
            (vehiculoCuatroEditar || vehiculoCuatroDuplicar) &&
    ...
    const editarDatosVehiculos = () => {
        ...
        if (count > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar o duplicar vehículo 41!"
            );
            return;
        }

        setVehiculoCuatroEditar(true);
        setVehiculoCuatroSelecc(false);
        setEditarTipoVeh(tipoVeh);
        setEditarMarcaVeh(marcaVehCuatro);
        setEditarAnnoVeh(annoVehCuatro);
        setEditarModeloVeh(modeloVehCuatro);
        setEditarCilindrajesVeh(cilindrajeVehCuatro);
        setEditarCarroceriaVeh(carroceriaVehCuatro);
        setEditarTransmisionVeh(transmisionVehCuatro);
        setEditarCombustibleVeh(combustibleVehCuatro);
        setEditarTraccionVeh(traccionVehCuatro);
    ...
    const duplicarDatosVehiculos = () => {
        ...
        if (count > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar o duplicar vehículo 42!"
            );
            return;
        }
        ...
        if (controlAccion > 0) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar, duplicar o eliminar 43!"
            );
            return;
        }
        ...
        listCarrocerias.forEach((row) => {
            if (
                Number.parseInt(row.id) === Number.parseInt(carroceriaVehCuatro)
            ) {
        ...
        listMarcas.forEach((row) => {
            if (Number.parseInt(row.id) === Number.parseInt(marcaVehCuatro)) {
                duplicarMarca = row.text;
            }
        });

        annos.forEach((row) => {
            if (Number.parseInt(row.id) === Number.parseInt(annoVehCuatro)) {
                duplicarAnno = row.anovehiculo;
            }
        });

        listModelos.forEach((row) => {
            if (Number.parseInt(row.id) === Number.parseInt(modeloVehCuatro)) {
        ...
        listCilindrajes.forEach((row) => {
            if (
                Number.parseInt(row.id) === Number.parseInt(cilindrajeVehCuatro)
            ) {
        ...
        let duplicar = {
            tipoVeh: tipoVeh,
            marcaVeh: marcaVehCuatro,
            annoVeh: annoVehCuatro,
            modeloVeh: modeloVehCuatro,
            cilindrajesVeh: cilindrajeVehCuatro,
            carroceriaVeh: carroceriaVehCuatro,
            transmisionVeh: transmisionVehCuatro,
            combustibleVeh: combustibleVehCuatro,
            traccionVeh: traccionVehCuatro,
    ...
    const eliminaDatosVehiculos = () => {
        ...
        setMarcaVehCuatro(0);
        setAnnoVehCuatro(0);
        setModeloVehCuatro(0);
        setCarroceriaVehCuatro(0);
        setcilindrajeVehCuatro(0);
        settransmisionVehCuatro(0);
        setcombustibleVehCuatro(0);
        settraccionVehCuatro(0);
        setVehiculoBorrar(false);
    ...
    const eliminaDatosVehiculosAgregado = () => {
        if (controlAccion > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar, duplicar o eliminar 44!"
            );
            return;
        }
            ...
            vehiculosSeleccionados &&
                vehiculosSeleccionados.map((items) => {
                    if (items.dato.valor == vehiculo) {
                        ...
                        setTituloMensajes("Información del producto");
                        setTextoMensajes(
                            "Heey, No puedes grabar dos vehícuos iguales 47!"
                        );
                        return;
                    }
                });
...
export default DatosVehiculosCuatro;

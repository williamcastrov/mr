...
const CreateProduct = () => {
    ...
    const [controlAbrir, setControlAbrir] = useState(false);
    ...
    useEffect(() => {
        let tipo = localStorage.getItem("tipovehiculo")
        if(tipo === "2"){
            setTipoVehSelec(2)
        }
    }, [contador]);
                                            ...
                                            <Row>
                                                <Row>
                                                    ...
                                                    <Col
                                                        ...
                                                        <Button
                                                            variant="outline-light"
                                                            className="iconomotorelectricocrearproducto ml-3"
                                                            onClick={
                                                                SeleccionasistemaElectrico
                                                            }>
                                                            <img
                                ...
                                <Row className="mtmenos10">
                                    <Col lg={6} xl={6} md={6} xs={6}>
                                        ...
                                        <div className={inputNumeroUnidades}>
                                            ...
                                            <NumberFormat
                                                className="ml-20 eliminarborde colordelfondo"
                                            ...
                                            <button
                                                className="ml-10 eliminarborde baseinput"
                                                type="button"

...
function DatosVehiculosDiez(props) {
    const {
        vehiculoDiezCrear,
    ...
    useEffect(() => {
        if (vehiculoBorrar && !duplicar && !vehiculoDiezEditar) {
            setVehiculoBorrar(false);
        }
    }, [vehiculoBorrar]);

    useEffect(() => {
        if (vehiculoDiezCrear) {
            setMarcaVeh("");
            setAnnoVeh("");
            setModeloVeh("");
            setCilindrajesVeh("");
    ...
    useEffect(() => {
        if (vehiculoDiezEditar) {
            setMarcaVeh(marcaVehDiez);
            setAnnoVeh(annoVehDiez);
            setModeloVeh(modeloVehDiez);
            setCilindrajesVeh(cilindrajeVehDiez);
            setCarroceriaVeh(carroceriaVehDiez);
            setTransmisionVeh(transmisionVehDiez);
            setCombustibleVeh(combustibleVehDiez);
            setTraccionVeh(traccionVehDiez);
            listCarrocerias.forEach((row) => {
                if (
                    Number.parseInt(row.id) ===
                    Number.parseInt(carroceriaVehDiez)
                ) {
            ...
            listMarcas.forEach((row) => {
                if (Number.parseInt(row.id) === Number.parseInt(marcaVehDiez)) {
                    setSelectMarca(row.text);
                }
            });

            annos.forEach((row) => {
                if (Number.parseInt(row.id) === Number.parseInt(annoVehDiez)) {
            ...
            listModelos.forEach((row) => {
                if (
                    Number.parseInt(row.id) === Number.parseInt(modeloVehDiez)
                ) {
    ...
    useEffect(() => {
        if (controlGrabar) {
                ...
                vehiculosSeleccionados &&
                    vehiculosSeleccionados.map((items) => {
                        if (items.dato.valor == vehiculo) {
                            ...
                            setTextoMensajes(
                                "Heey, No puedes grabar dos vehícuos iguales 102!"
                            );
                            continuar = false;
                            return;
                            setcontrolGrabar(false);
            ...
            setTipoVehDiez(tipoVehSelec);
            setMarcaVehDiez(marcaVeh);
            setAnnoVehDiez(annoVeh);
            setModeloVehDiez(modeloVeh);
            setcilindrajeVehDiez(cilindrajesVeh);
            setCarroceriaVehDiez(carroceriaVeh);
            settransmisionVehDiez(transmisionVeh);
            setcombustibleVehDiez(combustibleVeh);
            settraccionVehDiez(traccionVeh);
    ...
    const handleChange = (selectedOptions) => {
        ...
        setCarrocerias(newDet);
        if (!vehiculoDiezEditar && !vehiculoDiezDuplicar)
            setcontrolGrabar(true);
    };
    ...
    const handleChangeCarroceria = (selectedOptions) => {
        ...
        if (vehiculoDiezEditar || vehiculoDiezDuplicar) setEditarMarca(true);

        if (
            (vehiculoDiezEditar || vehiculoDiezDuplicar) &&
    ...
    const handleChangeModels = (selectedOptions) => {
        ...
        if (vehiculoDiezEditar || vehiculoDiezDuplicar) setEditarModelo(true);
    ...
    const editarDatosVehiculos = () => {
        ...
        if (count > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar o duplicar vehículo 101!"
            );
            return;
        }

        setVehiculoDiezEditar(true);
        setVehiculoDiezSelecc(false);
        setEditarTipoVeh(tipoVeh);
        setEditarMarcaVeh(marcaVehDiez);
        setEditarAnnoVeh(annoVehDiez);
        setEditarModeloVeh(modeloVehDiez);
        setEditarCilindrajesVeh(cilindrajeVehDiez);
        setEditarCarroceriaVeh(carroceriaVehDiez);
        setEditarTransmisionVeh(transmisionVehDiez);
        setEditarCombustibleVeh(combustibleVehDiez);
        setEditarTraccionVeh(traccionVehDiez);
    ...
    const duplicarDatosVehiculos = () => {
        ...
        if (count > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar o duplicar vehículo 102!"
            );
            return;
        }
        ...
        listCarrocerias.forEach((row) => {
            if (
                Number.parseInt(row.id) === Number.parseInt(carroceriaVehDiez)
            ) {
        ...
        listModelos.forEach((row) => {
            if (Number.parseInt(row.id) === Number.parseInt(modeloVehDiez)) {
        ...
        listCilindrajes.forEach((row) => {
            if (
                Number.parseInt(row.id) === Number.parseInt(cilindrajeVehDiez)
            ) {
        ...
        let duplicar = {
            tipoVeh: tipoVeh,
            marcaVeh: marcaVehDiez,
            annoVeh: annoVehDiez,
            modeloVeh: modeloVehDiez,
            cilindrajesVeh: cilindrajeVehDiez,
            carroceriaVeh: carroceriaVehDiez,
            transmisionVeh: transmisionVehDiez,
            combustibleVeh: combustibleVehDiez,
            traccionVeh: traccionVehDiez,
    ...
    const eliminaDatosVehiculos = () => {
        ...
        setAnnoVehDiez(0);
        setModeloVehDiez(0);
        setCarroceriaVehDiez(0);
        setcilindrajeVehDiez(0);
        settransmisionVehDiez(0);
        setcombustibleVehDiez(0);
        settraccionVehDiez(0);
        setVehiculoBorrar(false);
    ...
    const grabarDatosVehiculos = () => {
        //if (!vehiculoDiezCrear && !vehiculoDiezDuplicar && !vehiculoDiezEditar) {
        let count = 0;
        setControlAccion(count);
        //}
        ...
        if (editarCambioMarca == 2) {
            if (editarCambioModelo == 2 && editarCambioCilindraje == 2) {
                ...
                setTituloMensajes("Información del producto");
                setTextoMensajes(
                    "Heey, Ingresa los datos de Modelo y Cilindraje 3!"
                );
                let count = 1;
                setControlAccion(count);
                return;
    ...
    const guardarDatosVehiculosDuplicar = () => {
        ...
        if (editarCambioCarroceria == 1) {
            if (
                ...
                setTituloMensajes("Información del producto");
                setTextoMensajes(
                    "Heey, Ingresa los datos de Marca, Modelo y Cilindraje 1!"
                );
                return;
            }
        }
        ...
        if (editarCambioMarca == 2) {
            if (editarCambioModelo == 2 && editarCambioCilindraje == 2) {
                ...
                setTituloMensajes("Información del producto");
                setTextoMensajes(
                    "Heey, Ingresa los datos de Modelo y Cilindraje 2!"
                );
                return;
            }
        }
            ...
            vehiculosSeleccionados &&
                vehiculosSeleccionados.map((items) => {
                    if (items.dato.valor == vehiculo) {
                        ...
                        setTituloMensajes("Información del producto");
                        setTextoMensajes(
                            "Heey, No puedes grabar dos vehícuos iguales 107!"
                        );
                        return;
                    }
                });
                            ...
                            <div>
                                ...
                                <Row>
                                        ...
                                        <div className="mtmenos2">
                                            <Dropdown
                                                ...
                                                <Dropdown.Toggle
                                                    ...
                                                    variant="outline-light"
                                                    id="dropdown-basic">
                                                    <div className="ml-2 alinearizquierda">
                                                        {selectCarroceria}
                                                    </div>
                                                </Dropdown.Toggle>
                                    ...
                                    <Col xl={6} lg={6} md={6} xs={6}>
                                        <div className="mtmenos1 mlmenos17">
                                            <Dropdown
                ...
                <Row>
                    <div className="ml-17">
                        ...
                        <Row >
                            ...
                            <Col xl={6} lg={6} md={6} xs={6}>
                                <div className="mtmenos2 mlmenos17">
                                    <Dropdown
                                        onSelect={handleChangeBrand}
                                        onClick={onClickMarca}>
                                        <Dropdown.Toggle
...
export default DatosVehiculosDiez;

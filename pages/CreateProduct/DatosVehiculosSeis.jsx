...
function DatosVehiculosSeis(props) {
    const {
        vehiculoSeisCrear,
    ...
    useEffect(() => {
        if (vehiculoBorrar && !duplicar && !vehiculoSeisEditar) {
            setVehiculoBorrar(false);
        }
    }, [vehiculoBorrar]);

    useEffect(() => {
        if (vehiculoSeisCrear) {
            setMarcaVeh("");
            setAnnoVeh("");
            setModeloVeh("");
            setCilindrajesVeh("");
    ...
    useEffect(() => {
        if (vehiculoSeisEditar) {
            setMarcaVeh(marcaVehSeis);
            setAnnoVeh(annoVehSeis);
            setModeloVeh(modeloVehSeis);
            setCilindrajesVeh(cilindrajeVehSeis);
            setCarroceriaVeh(carroceriaVehSeis);
            setTransmisionVeh(transmisionVehSeis);
            setCombustibleVeh(combustibleVehSeis);
            setTraccionVeh(traccionVehSeis);
            listCarrocerias.forEach((row) => {
                if (
                    Number.parseInt(row.id) ===
                    Number.parseInt(carroceriaVehSeis)
                ) {
            ...
            listMarcas.forEach((row) => {
                if (Number.parseInt(row.id) === Number.parseInt(marcaVehSeis)) {
                    setSelectMarca(row.text);
                }
            });

            annos.forEach((row) => {
                if (Number.parseInt(row.id) === Number.parseInt(annoVehSeis)) {
            ...
            listModelos.forEach((row) => {
                if (
                    Number.parseInt(row.id) === Number.parseInt(modeloVehSeis)
                ) {
    ...
    useEffect(() => {
        if (controlGrabar) {
                ...
                vehiculosSeleccionados &&
                    vehiculosSeleccionados.map((items) => {
                        if (items.dato.valor == vehiculo) {
                            ...
                            setTextoMensajes(
                                "Heey, No puedes grabar dos vehícuos iguales 62!"
                            );
                            continuar = false;
                            return;
                            setcontrolGrabar(false);
            ...
            setTipoVehSeis(tipoVehSelec);
            setMarcaVehSeis(marcaVeh);
            setAnnoVehSeis(annoVeh);
            setModeloVehSeis(modeloVeh);
            setcilindrajeVehSeis(cilindrajesVeh);
            setCarroceriaVehSeis(carroceriaVeh);
            settransmisionVehSeis(transmisionVeh);
            setcombustibleVehSeis(combustibleVeh);
            settraccionVehSeis(traccionVeh);
    ...
    const handleChange = (selectedOptions) => {
        ...
        setCarrocerias(newDet);
        if (!vehiculoSeisEditar && !vehiculoSeisDuplicar)
    ...
    const handleChangeCarroceria = (selectedOptions) => {
        ...
        listCarrocerias.forEach((row) => {
            if (Number.parseInt(row.id) === Number.parseInt(selectedOptions)) {
                setNombreCarroceriaVeh(row.carroceria);
                //console.log("NOMBRE CARROCERIA SELECCIODA : ", row.carroceria);
            }
        });
    ...
    const handleChangeBrand = (selectedOptions) => {
        ...
        if (
            (vehiculoSeisEditar || vehiculoSeisDuplicar) &&
    ...
    const handleChangeModels = (selectedOptions) => {
        ...
        if (vehiculoSeisEditar || vehiculoSeisDuplicar) setEditarModelo(true);
    ...
    const editarDatosVehiculos = () => {
        ...
        if (count > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar o duplicar vehículo 61!"
            );
            return;
        }

        setVehiculoSeisEditar(true);
        setVehiculoSeisSelecc(false);
        setEditarTipoVeh(tipoVeh);
        setEditarMarcaVeh(marcaVehSeis);
        setEditarAnnoVeh(annoVehSeis);
        setEditarModeloVeh(modeloVehSeis);
        setEditarCilindrajesVeh(cilindrajeVehSeis);
        setEditarCarroceriaVeh(carroceriaVehSeis);
        setEditarTransmisionVeh(transmisionVehSeis);
        setEditarCombustibleVeh(combustibleVehSeis);
        setEditarTraccionVeh(traccionVehSeis);
    ...
    const duplicarDatosVehiculos = () => {
        ...
        if (count > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar o duplicar vehículo 62!"
            );
            return;
        }
        ...
        listCarrocerias.forEach((row) => {
            if (
                Number.parseInt(row.id) === Number.parseInt(carroceriaVehSeis)
            ) {
        ...
        listModelos.forEach((row) => {
            if (Number.parseInt(row.id) === Number.parseInt(modeloVehSeis)) {
        ...
        listCilindrajes.forEach((row) => {
            if (
                Number.parseInt(row.id) === Number.parseInt(cilindrajeVehSeis)
            ) {
        ...
        let duplicar = {
            tipoVeh: tipoVeh,
            marcaVeh: marcaVehSeis,
            annoVeh: annoVehSeis,
            modeloVeh: modeloVehSeis,
            cilindrajesVeh: cilindrajeVehSeis,
            carroceriaVeh: carroceriaVehSeis,
            transmisionVeh: transmisionVehSeis,
            combustibleVeh: combustibleVehSeis,
            traccionVeh: traccionVehSeis,
    ...
    const eliminaDatosVehiculos = () => {
        ...
        setAnnoVehSeis(0);
        setModeloVehSeis(0);
        setCarroceriaVehSeis(0);
        setcilindrajeVehSeis(0);
        settransmisionVehSeis(0);
        setcombustibleVehSeis(0);
        settraccionVehSeis(0);
        setVehiculoBorrar(false);
    ...
    const eliminaDatosVehiculosAgregado = () => {
        if (controlAccion > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar, duplicar o eliminar 63"
            );
            return;
        }
    ...
    const grabarDatosVehiculos = () => {
        //if (!vehiculoSeisCrear && !vehiculoSeisDuplicar && !vehiculoSeisEditar) {
        let count = 0;
        setControlAccion(count);
        //}
            ...
            vehiculosSeleccionados &&
                vehiculosSeleccionados.map((items) => {
                    if (items.dato.valor == vehiculo) {
                        ...
                        setTituloMensajes("Información del producto");
                        setTextoMensajes(
                            "Heey, No puedes grabar dos vehícuos iguales 67!"
                        );
                        return;
                    }
                });
...
export default DatosVehiculosSeis;

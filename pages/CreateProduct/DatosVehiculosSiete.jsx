...
function DatosVehiculosSiete(props) {
    ...
    useEffect(() => {
        if (vehiculoBorrar && !duplicar && !vehiculoSieteEditar) {
            setVehiculoBorrar(false);
        }
    }, [vehiculoBorrar]);

    useEffect(() => {
        if (vehiculoSieteCrear) {
            setMarcaVeh("");
            setAnnoVeh("");
            setModeloVeh("");
            setCilindrajesVeh("");
    ...
    useEffect(() => {
        if (vehiculoSieteEditar) {
            setMarcaVeh(marcaVehSiete);
            setAnnoVeh(annoVehSiete);
            setModeloVeh(modeloVehSiete);
            setCilindrajesVeh(cilindrajeVehSiete);
            setCarroceriaVeh(carroceriaVehSiete);
            setTransmisionVeh(transmisionVehSiete);
            setCombustibleVeh(combustibleVehSiete);
            setTraccionVeh(traccionVehSiete);
            listCarrocerias.forEach((row) => {
                if (
                    Number.parseInt(row.id) ===
                    Number.parseInt(carroceriaVehSiete)
                ) {
            ...
            listMarcas.forEach((row) => {
                if (
                    Number.parseInt(row.id) === Number.parseInt(marcaVehSiete)
                ) {
            ...
            annos.forEach((row) => {
                if (Number.parseInt(row.id) === Number.parseInt(annoVehSiete)) {
            ...
            listModelos.forEach((row) => {
                if (
                    Number.parseInt(row.id) === Number.parseInt(modeloVehSiete)
                ) {
            ...
            listCilindrajes &&
                listCilindrajes.forEach((row) => {
                    if (
                        ...
                        Number.parseInt(modeloVehSiete)
                    ) {
                        let item = {
                            id: row.id,
                            carroceria: row.carroceria,
    ...
    useEffect(() => {
        if (controlGrabar) {
                ...
                vehiculosSeleccionados &&
                    vehiculosSeleccionados.map((items) => {
                        if (items.dato.valor == vehiculo) {
                            ...
                            setTextoMensajes(
                                "Heey, No puedes grabar dos vehícuos iguales 72!"
                            );
                            continuar = false;
                            return;
                            setcontrolGrabar(false);
            ...
            setTipoVehSiete(tipoVehSelec);
            setMarcaVehSiete(marcaVeh);
            setAnnoVehSiete(annoVeh);
            setModeloVehSiete(modeloVeh);
    ...
    const handleChange = (selectedOptions) => {
        ...
        setCarrocerias(newDet);
        if (!vehiculoSieteEditar && !vehiculoSieteDuplicar)
    ...
    const handleChangeBrand = (selectedOptions) => {
        ...
        if (
            (vehiculoSieteEditar || vehiculoSieteDuplicar) &&
    ...
    const handleChangeModels = (selectedOptions) => {
        ...
        if (vehiculoSieteEditar || vehiculoSieteDuplicar) setEditarModelo(true);
    ...
    const editarDatosVehiculos = () => {
        ...
        if (count > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar o duplicar vehículo 71!"
            );
            return;
        }
        ...
        setEditarMarcaVeh(marcaVehSiete);
        setEditarAnnoVeh(annoVehSiete);
        setEditarModeloVeh(modeloVehSiete);
        setEditarCilindrajesVeh(cilindrajeVehSiete);
        setEditarCarroceriaVeh(carroceriaVehSiete);
        setEditarTransmisionVeh(transmisionVehSiete);
        setEditarCombustibleVeh(combustibleVehSiete);
        setEditarTraccionVeh(traccionVehSiete);
    ...
    const duplicarDatosVehiculos = () => {
        ...
        if (count > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar o duplicar vehículo 72!"
            );
            return;
        }
        ...
        listCarrocerias.forEach((row) => {
            if (
                Number.parseInt(row.id) === Number.parseInt(carroceriaVehSiete)
            ) {
        ...
        listMarcas.forEach((row) => {
            if (Number.parseInt(row.id) === Number.parseInt(marcaVehSiete)) {
        ...
        listModelos.forEach((row) => {
            if (Number.parseInt(row.id) === Number.parseInt(modeloVehSiete)) {
        ...
        listCilindrajes.forEach((row) => {
            if (
                Number.parseInt(row.id) === Number.parseInt(cilindrajeVehSiete)
            ) {
        ...
        let duplicar = {
            tipoVeh: tipoVeh,
            marcaVeh: marcaVehSiete,
            annoVeh: annoVehSiete,
            modeloVeh: modeloVehSiete,
            cilindrajesVeh: cilindrajeVehSiete,
            carroceriaVeh: carroceriaVehSiete,
            transmisionVeh: transmisionVehSiete,
            combustibleVeh: combustibleVehSiete,
            traccionVeh: traccionVehSiete,
    ...
    const eliminaDatosVehiculos = () => {
        ...
        setAnnoVehSiete(0);
        setModeloVehSiete(0);
        setCarroceriaVehSiete(0);
        setcilindrajeVehSiete(0);
        settransmisionVehSiete(0);
        setcombustibleVehSiete(0);
        settraccionVehSiete(0);
        setVehiculoBorrar(false);
    ...
    const eliminaDatosVehiculosAgregado = () => {
        if (controlAccion > 1) {
            ...
            setTituloMensajes("Información del producto");
            setTextoMensajes(
                "Heey, solo una acción a la vez, crear, editar, duplicar o eliminar 73!"
            );
            return;
        }
    ...
    const grabarDatosVehiculos = () => {
        //if (!vehiculoSieteCrear && !vehiculoSieteDuplicar && !vehiculoSieteEditar) {
        let count = 0;
        setControlAccion(count);
        //}
            ...
            vehiculosSeleccionados &&
                vehiculosSeleccionados.map((items) => {
                    if (items.dato.valor == vehiculo) {
                        ...
                        setTituloMensajes("Información del producto");
                        setTextoMensajes(
                            "Heey, No puedes grabar dos vehícuos iguales 77!"
                        );
                        return;
                    }
                });
